...
- Which out-of-range inputs must be rejected or safely handled?
- Which event-ordering or race conditions can occur between collaborating services?
...
- **FR-006**: System MUST define clear domain/infrastructure boundaries consistent
  with hexagonal architecture and DDD.
- **FR-007**: System MUST describe how decoupled services communicate through
...
- **DR-001**: User-facing documentation updates MUST be identified in scope when
